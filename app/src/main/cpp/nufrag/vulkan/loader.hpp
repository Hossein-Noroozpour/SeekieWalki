...
namespace nufrag {
    namespace vulkan {
        ...
        public:
            Loader();
            extern PFN_vkCreateInstance create_instance;
            extern PFN_vkDestroyInstance destroy_instance;
            extern PFN_vkEnumeratePhysicalDevices enumerate_physical_devices;
